...
// Line joiners
export function lines(lines) { return lines.join('\n'); }
export function list(lines) { return lines.join(', '); }
export function statements(lines) { return lines.join(';\n'); }
...
export function links(links) {
  ...
  for (let l of Array.from(links)) { link(l, out); }
